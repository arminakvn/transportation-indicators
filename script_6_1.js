(function() {
  ...
  */
  var url = "https://arminavn.cartodb.com/api/v2/sql?q=SELECT * FROM table_6_1 ORDER BY mode   &api_key=9150413ca8fb81229459d0a5c2947620e42d0940";
    ...
    d3.json(url, function(j) {
      ...
      var chart = c3.generate({
        ...
        data: {
            json: data_parsed,
            keys: {
                value: ["All Races Ethnicities", "Asian", "Black", "Latino", "Mode", "White", "Other"]
            },
            groups: [["All Races Ethnicities", "Asian", "Black", "Latino", "Mode", "White", "Other]],
            // colors: {
